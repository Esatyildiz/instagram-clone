const homeIcon = ({ size }) => {
    return (
        <svg aria-label="Ana Sayfa" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
            <path d="M9.005 16.545a2.997 2.997 0 0 1 2.997-2.997A2.997 2.997 0 0 1 15 16.545V22h7V11.543L12 2 2 11.543V22h7.005Z" fill="none" stroke="currentColor" strokeLinejoin strokeWidth="2">
            </path>
        </svg>
...
const homeActiveIcon = ({ size }) => {
    return (
        <svg aria-label="Ana Sayfa" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
            <path d="M9.005 16.545a2.997 2.997 0 0 1 2.997-2.997A2.997 2.997 0 0 1 15 16.545V22h7V11.543L12 2 2 11.543V22h7.005Z" fill="#000" stroke="currentColor" strokeLinejoin strokeWidth="2">
            </path>
        </svg>
...
const searchIcon = ({ size }) => {
    return (
        <svg aria-label="Ara" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const activeSearchIcon = ({ size }) => {
    return (
        <svg aria-label="Ara" class="_ab6-" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const discoverIcon = ({ size }) => {
    return (
        <svg aria-label="Keşfet" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const activeDiscoverIcon = ({ size }) => {
    return (
        <svg aria-label="Keşfet" class="_ab6-" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const reelsIcon = ({ size }) => {
    return (
        <svg aria-label="Reels" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const activeReelsIcon = ({ size }) => {
    return (
        <svg aria-label="Reels" class="_ab6-" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const messageIcon = ({ size }) => {
    return (
        <svg aria-label="Messenger" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const activeMessageIcon = ({ size }) => {
    return (
        <svg aria-label="Messenger" class="x1lliihq x1n2onr6" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const notificationsIcon = ({ size }) => {
    return (
        <svg aria-label="Bildirimler" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const activeNotificationsIcon = ({ size }) => {
    return (
        <svg aria-label="Bildirimler" class="_ab6-" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height={size} role="img" viewBox="0 0 48 48" width={size}><path d="M34.6 3.1c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5s1.1-.2 1.6-.5c1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z"></path></svg>
    );
}

const createIcon = ({ size }) => {
    return (
        <svg aria-label="Yeni Gönderi" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const activeCreateIcon = ({ size }) => {
    return (
        <svg aria-label="Yeni Gönderi" class="_ab6-" color="rgb(38, 38, 38)" fill="rgb(38, 38, 38)" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const moreIcon = ({ size }) => {
    return (
        <svg aria-label="Ayarlar" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const ayarlarIcon = ({ size }) => {
    return (
        <svg aria-label="Ayarlar" class="_ab6-" color="rgb(38, 38, 38)" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width="24">
...
const movesIcon = ({ size }) => {
    return (
        <svg aria-label="Hareketlerin" class="_ab6-" color="rgb(38, 38, 38)" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
            <path d="M12 1.505a10.5 10.5 0 11-7.424 17.924" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2">
            </path>
...
const kaydetIcon = ({ size }) => {
    return (
        <svg aria-label="Kaydedilenler" class="_ab6-" fill="rgb(38, 38, 38)" height={size} role="img" viewBox="0 0 24 24" width="24">
...
const gorunumIcon = ({ size }) => {
    return (
        <svg aria-label="Tema simgesi" class="_ab6-" fill="currentColor" height={size} role="img" viewBox="0 0 16 16" width={size}>
            <path d="M8.05 16C3.61 16 0 12.39 0 7.95 0 3.99 2.83.65 6.72 0c.49-.03.87.22.99.6.11.38-.05.78-.41 1-1.7.93-2.75 2.69-2.75 4.61 0 2.89 2.35 5.25 5.25 5.25a5.25 5.25 0 0 0 4.61-2.74c.19-.37.61-.54 1.01-.4.42.14.66.56.58 1.01A8.044 8.044 0 0 1 8.05 16zM5.8 1.32c-2.78.93-4.73 3.56-4.73 6.63 0 3.85 3.13 6.99 6.99 6.99 3.04 0 5.66-1.93 6.61-4.72a6.301 6.301 0 0 1-4.87 2.31c-3.48 0-6.31-2.83-6.31-6.31-.01-1.93.86-3.71 2.31-4.9zm9.54 7.89s0 .01 0 0c0 .01 0 0 0 0z" fill="currentColor">
            </path>
        </svg>
    );
}

const sorunIcon = ({ size }) => {
    return (
        <svg aria-label="Bir sorun bildir" class="_ab6-" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const instagramIcon = ({ size }) => {
    return (
        <svg aria-label="Instagram" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const heartlIcon = ({ size }) => {
    return (
        <svg aria-label="Beğen" class="x1lliihq x1n2onr6" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
...
const commentsIcon = ({ size }) => {
    return (
        <svg aria-label="Yorum Yap" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
            <path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="2px">
            </path>
        </svg>
    );
}
const gonderiIcon = ({ size }) => {
    return (
        <svg aria-label="Gönderi Paylaş" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
            <line fill="none" stroke="#262626" strokeLinejoin="round" strokeWidth="2px" x1="22" x2="9.218" y1="3" y2="10.083">
            </line>
            <polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="currentColor" strokeLinejoin="round" strokeWidth="2px">
            </polygon>
        </svg>
    );
}
...
const saveIcon = ({ size }) => {
    return (
        <svg aria-label="Kaydet" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
            <polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2px">
            </polygon>
        </svg>
    );
}
...
const closeIcon = ({ size }) => {
    return (
        <svg aria-label="Kapat" fill="currentColor" height={size} role="img" viewBox="0 0 24 24" width={size}>
            <title>Kapat</title>
...
const copyIcon = ({ size }) => {
    return (
        <svg aria-label="Döngü" class="x1lliihq x1n2onr6 x1hfr7tm" color="rgb(255, 255, 255)" fill="rgb(255, 255, 255)" height={size} role="img" viewBox="0 0 48 48" width={size}>
            <title>Döngü</title>
            <path d="M34.8 29.7V11c0-2.9-2.3-5.2-5.2-5.2H11c-2.9 0-5.2 2.3-5.2 5.2v18.7c0 2.9 2.3 5.2 5.2 5.2h18.7c2.8-.1 5.1-2.4 5.1-5.2zM39.2 15v16.1c0 4.5-3.7 8.2-8.2 8.2H14.9c-.6 0-.9.7-.5 1.1 1 1.1 2.4 1.8 4.1 1.8h13.4c5.7 0 10.3-4.6 10.3-10.3V18.5c0-1.6-.7-3.1-1.8-4.1-.5-.4-1.2 0-1.2.6z"></path></svg>
    );
}

const videoIcon = ({ size }) => {
    return (
        <svg aria-label="Reels videosu" class="x1lliihq x1n2onr6 x1hfr7tm" color="rgb(255, 255, 255)" fill="rgb(255, 255, 255)" height={size} role="img" viewBox="0 0 24 24" width={size}><title>Reels videosu</title><path d="m12.823 1 2.974 5.002h-5.58l-2.65-4.971c.206-.013.419-.022.642-.027L8.55 1Zm2.327 0h.298c3.06 0 4.468.754 5.64 1.887a6.007 6.007 0 0 1 1.596 2.82l.07.295h-4.629L15.15 1Zm-9.667.377L7.95 6.002H1.244a6.01 6.01 0 0 1 3.942-4.53Zm9.735 12.834-4.545-2.624a.909.909 0 0 0-1.356.668l-.008.12v5.248a.91.91 0 0 0 1.255.84l.109-.053 4.545-2.624a.909.909 0 0 0 .1-1.507l-.1-.068-4.545-2.624Zm-14.2-6.209h21.964l.015.36.003.189v6.899c0 3.061-.755 4.469-1.888 5.64-1.151 1.114-2.5 1.856-5.33 1.909l-.334.003H8.551c-3.06 0-4.467-.755-5.64-1.889-1.114-1.15-1.854-2.498-1.908-5.33L1 15.45V8.551l.003-.189Z" fill-rule="evenodd"></path></svg>
    );
}
...
const Icon = ({ name, size = 24, className }) => {
    ...
    const icons = {
        ...
        activeDiscover: activeDiscoverIcon,
        activeReels: activeReelsIcon,
        activeMessage: activeMessageIcon,
        activeNotifications: activeNotificationsIcon,
        activeCreate: activeCreateIcon,
        video: videoIcon,
        copy: copyIcon,
